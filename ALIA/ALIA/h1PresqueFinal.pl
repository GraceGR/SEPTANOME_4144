...
%X et Y sont les cordonnees de la case, G la grille de jeu et R le resultat
%%404 est renvoyé si la case est sur le bord
voisin_haut([X2,Y],R, G):-trouverElement2Dimensions(X,Y,R,G),X2 is X+1, X<6, Y<7, X>0,!.
...
heuristique1(G,LCP,J,C3):-indice_coup_choisi(LCP,G,J,K),trouverElement(K,C3,_).
