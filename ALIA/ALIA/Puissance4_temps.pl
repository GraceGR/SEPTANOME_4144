...
jouerAvecHeuristique(G,LCP,J,C) :-  J==1, heuristique3(G,LCP,J,C). %Le joueur 1 joue avec l'heuristique attaque/defense
jouerAvecHeuristique(G,LCP,J,C) :- J==2, heuristique2(G,LCP,J,C). %2 joue avec l'heuristique attaque
