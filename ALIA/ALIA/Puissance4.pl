...
jouerAvecHeuristique(G,LCP,J,C) :-  J==1, heuristique3(G,LCP,J,C). %Le joueur 1 joue avec l'heuristique attaque et defense orientee attaque
jouerAvecHeuristique(G,LCP,J,C) :- J==2, heuristique4(G,LCP,J,C). %2 joue avec l'heuristique attaque/défense
