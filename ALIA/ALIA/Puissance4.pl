...
%jouerAvecHeuristique(G,LCP,J,C) :- J==2, aleatoire(LCP,C). %Le joueur 2 joue aléatoirement
jouerAvecHeuristique(G,LCP,J,C) :- J==2, attaque(G,LCP,J,C). %Le joueur 2 joue avec l'heuristique d'attaque
