...
% a deja trois pions alignes dans un sens (CMAX= 30).
...
% Recuperer le max entre M1,M2,M3,M4,M5,M6,M7,M8 et mettre le
% resultat dans M
...
% places à cote de la case de coordonnees [X][Y], avec le resultat mit dans M1.
...
% pour voir le nombre de pions appartenant au joueur J, consecutivement
% places à cote de la case de coordonnées [X][Y], avec le resultat mit dans M1.
...
% partir de la case de coordonnees [X][Y] de trois coups vers le haut
% gauche en utilisant le compteur CMT, pour voir le nombre de pions
% appartenant au joueur J, consecutivement places a cote de la case de
...
% appartenant au joueur J, consecutivement places a cote de la case de
% coordonnees [X][Y], avec le resultat mit dans M1.
...
% Parcourir la diagonale (X,Y) de la grille G, en se deplacant a
% partir de la case de coordonnees [X][Y] de trois coups vers le bas
% gauche en utilisant le compteur CMT, pour voir le nombre de pions
% appartenant au joueur J, consecutivement places a cote de la case de
% coordonnees [X][Y], avec le resultat mit dans M1.
